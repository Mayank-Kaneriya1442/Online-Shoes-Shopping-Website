...
// Fetch products specifically for Cricket Shoes
$query = "SELECT * FROM product WHERE pgname='Cricket Shoes'";
...
<head>
    ...
    <title>Cricket Shoes - SoleStyle</title>
...
<body>
    ...
    <header class="page-header">
        <div class="container">
            <h2>Cricket Shoes</h2>
            <p class="lead">Performance footwear for the gentleman's game</p>
        </div>
    </header>
