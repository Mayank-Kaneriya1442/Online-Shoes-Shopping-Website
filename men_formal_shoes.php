...
// Define your query
$query = "SELECT * FROM product WHERE pgname='Men Formal Shoes'";
                ...
                <div class="col-md-4 mb-4">
                    <div class="product-card">
                        <div class="product-image">
                            <img src="images/men_formal_shoes/<?php echo htmlentities($row['pimage']); ?>" class="img-fluid h-100 w-100" alt="">
                        </div>
                        <div class="product-info">
                            <h5 class="product-name">Brand: <?php echo htmlentities($row['pname']); ?></h5>
                            <h5 class="product-name">Men's Formal Shoes</h5>
