...
// Define your query
$query = "SELECT * FROM product WHERE pgname='Women Clogs'";
                ...
                <div class="col-md-4 mb-4">
                    <div class="product-card">
                        <div class="product-image">
                            <img src="shoes_admin/admin/images/<?php echo htmlentities($row['pimage']); ?>" class="img-fluid h-100 w-100" alt="">
                        </div>
                        <div class="product-info">
                            <h5 class="product-name">Brand: <?php echo htmlentities($row['pname']); ?></h5>
                            <h5 class="product-name">Women's Clog</h5>
