...
// Fetch products specifically for Boy's School Shoes
$query = "SELECT * FROM product WHERE pgname='Boys School Shoes'";
...
<head>
    ...
    <title>Boy's School Shoes - SoleStyle</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg fixed-top">
        <div class="container">
            ...
            <div class="d-flex align-items-center">
                ...
                <div href="sign_in.php" class="text-dark">
    ...
    <header class="page-header">
        <div class="container">
            <h2>Boy's School Shoes</h2>
            <p class="lead">Durable and comfortable shoes for the school day</p>
        </div>
    </header>
