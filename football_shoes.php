...
// Fetch products specifically for Football Shoes
$query = "SELECT * FROM product WHERE pgname='Football Shoes'";
...
<head>
    ...
    <title>Football Shoes - SoleStyle</title>
...
<body>
    ...
    <header class="page-header">
        <div class="container">
            ...
            <p class="lead">Dominate the field with superior grip and comfort</p>
        </div>
    </header>
