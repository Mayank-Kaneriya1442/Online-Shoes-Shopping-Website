...
// Fetch products specifically for Girl's School Shoes
$query = "SELECT * FROM product WHERE pgname='Girls School Shoes'";
...
<head>
    ...
    <title>Girl's School Shoes - SoleStyle</title>
...
<body>
    ...
    <header class="page-header">
        <div class="container">
            <h2>Girl's School Shoes</h2>
            <p class="lead">Stylish and sturdy footwear for school days</p>
        </div>
    </header>
