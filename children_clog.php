...
// Fetch products specifically for Children's Clog
$query = "SELECT * FROM product WHERE pgname='Children Clog'";
...
<head>
    ...
    <title>Children's Clogs - SoleStyle</title>
...
<body>
    ...
    <header class="page-header">
        <div class="container">
            <h2>Children's Clogs</h2>
            <p class="lead">Comfortable and fun footwear for little feet</p>
        </div>
    </header>
