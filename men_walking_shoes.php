...
$query = "SELECT * FROM product WHERE pgname='Men Walking Shoes'";
...
<head>
    ...
    <title>Men's Walking Shoes - SoleStyle</title>
...
<body>
    ...
    <header class="page-header">
        <div class="container">
            <h2>Men's Walking Shoes</h2>
            <p class="lead">Comfort and support for every step you take</p>
        </div>
    </header>
